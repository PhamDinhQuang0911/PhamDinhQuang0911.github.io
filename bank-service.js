...
(function(global) {
    ...
    const BankService = {
        ...
        async getMaxExistingCccd() {
            ...
            try {
                if (window.firebaseDb && window.firestoreDoc && window.firestoreGetDoc && navigator.onLine) {
                    const snap = await Promise.race([
                        window.firestoreGetDoc(window.firestoreDoc(window.firebaseDb, "configurations", "cccd_generator")),
        ...
        async updateLatestCccdCounter(lastCccdNum) {
            ...
            try {
                if (window.firebaseDb && window.firestoreDoc && window.firestoreSetDoc && navigator.onLine) {
                    window.firestoreSetDoc(window.firestoreDoc(window.firebaseDb, "configurations", "cccd_generator"), {
